...
void EffekseerEffect::load_in_editor()
{
	...
	godot::String materialPathStr = EffekseerGodot3::Convert::String16(materialPath) + "/";
	...
	auto enumerateResouces = [&](const char16_t* (Effekseer::Effect::*getter)(int) const, int count)
	{
		...
		{
			godot::String path = materialPathStr + EffekseerGodot3::Convert::String16((nativeptr->*getter)(i));
...
{
	int len = (int)EffekseerGodot3::Convert::String16(path, m_data_path, path_size);
